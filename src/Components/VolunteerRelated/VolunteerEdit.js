                    ...
                    .then(x => {
                        ...
                        if (d < files.length) {
                            ...
                            fileReader.onload = function (event) {
                                ...
                                if (eCon.current.value == '') {
                                    dataObj.contactInfo = singleVolunteer.ContactInformation;
                                } else {
                                    dataObj.contactInfo = eCon.current.value
                                }
            ...
            {singleVolunteer &&
                ...
                <Form>
                    <Form.Group>
                        ...
                        <Form.Control type="text" readOnly value={singleVolunteer.ContactInformation} placeholder="Contact Information" />
